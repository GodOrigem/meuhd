...
cscript //nologo ospp.vbs /act | find /i "successful" && (echo.&echo ============================================================================&echo.&echo. #Como funciona: bit.ly/kms-server&echo.&echo ============================================================================&choice /n /c SN /m "Clique N para fechar! [N]!" & if errorlevel 2 exit) || (echo A conexao com o meu servidor KMS Falhou! Tentando conectar a outro... & echo Por favor aguarde... & echo. & echo. & set /a i+=1 & goto server)
explorer &goto halt
:notsupported
